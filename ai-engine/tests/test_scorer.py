...
class TestS1GapOpen:
    ...
    def test_overheat_penalty_above_15pct(self):
        ...
        score_overheat = rule_score(signal, ctx)
        ctx_normal = _ctx(strength=160, flu_rt=4.0, bid_ratio=2.5)
        score_normal = rule_score(signal, ctx_normal)
    ...
    def test_penalty_10_to_15pct(self):
        ...
        score_penalty = rule_score(signal, ctx_11)
        score_normal = rule_score(signal, ctx_4)
    ...
    def test_cntr_strength_bonus(self):
        ...
        ctx = _ctx(strength=100, flu_rt=4.0, bid_ratio=0.5)
        score_with = rule_score(signal_with, ctx)
        score_without = rule_score(signal_without, ctx)
...
class TestS2ViPullback:
    ...
    def test_is_dynamic_true_bool(self):
        ...
        score_dyn = rule_score(signal_dyn, ctx)
        score_static = rule_score(signal_static, ctx)
...
class TestS4BigCandle:
    ...
    def test_is_new_high_adds_20(self):
        ...
        ctx = _ctx(strength=100, flu_rt=3.0, bid_ratio=0.5)
        assert rule_score(signal_high, ctx) == rule_score(signal_no, ctx) + 20
...
class TestS6ThemeLaggard:
    ...
    def test_cntr_strength_takes_priority_over_ctx(self):
        ...
        score_high_cntr = rule_score(signal_high_cntr, ctx_low)
        score_no_cntr = rule_score(signal_no_cntr, ctx_low)
