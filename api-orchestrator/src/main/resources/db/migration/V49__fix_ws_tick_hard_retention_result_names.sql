-- Preserve the readable partition name in the result row. A regclass rendered
-- after DROP resolves to its numeric OID because the relation no longer exists.
...
BEGIN
    ...
    LOOP
        ...
        object_name := 'public.' || part.relname;
        IF dry_run THEN
