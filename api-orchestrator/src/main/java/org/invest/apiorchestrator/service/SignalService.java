...
public class SignalService {
    ...
    private TradingSignal buildSignalEntity(TradingSignalDto dto) {
        ...
        return TradingSignal.builder()
                ...
                .setupVersion(family != null ? dto.getStrategy().name().toLowerCase() + "_family_v1" : null)
                .ruleScoreVersion(family != null ? StrategyFamilyCatalog.RULE_SCORE_VERSION : null)
                .promptVersion(family != null ? StrategyFamilyCatalog.PROMPT_VERSION : null)
                .confirmedByFamilyIds(family != null ? "[]" : null)
                .dataSource(family != null ? "{}" : null)
                .sourceTimestamp(family != null ? "{}" : null)
                .sourceAgeMs(family != null ? "{}" : null)
                .fallbackReason(family != null ? "[]" : null)
