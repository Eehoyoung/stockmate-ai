...
$metrics = [ordered]@{
    ...
    missing_family_lineage = Invoke-CanaryCount "select count(*) from trading_signals where created_at >= '$sinceIso' and strategy like 'S%' and (strategy_family is null or primary_setup_id is null or matched_setup_ids is null)"
